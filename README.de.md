...
<details>
<summary><b>🏠 Konfigurierbare Home-Widgets</b> — zum Aufklappen</summary>

<br/>

- **Uhr, Kalender (Datum) und Wetter** lassen sich einzeln an- und ausschalten.
- **Wetter** sitzt standardmäßig **oben rechts in der Ecke**, direkt unter der Statusleiste.
- Jedes Widget ist im Bearbeiten-Modus der Startseite **frei verschiebbar** (Drag & Drop).
- Die Uhr bleibt **synchron** zur Systemzeit und springt punktgenau zur vollen Minute um.

</details>

<details>
<summary><b>🎬 Granulare Animationssteuerung</b> — zum Aufklappen</summary>

<br/>

- Ein **Master-Schalter**, um alle Animationen an- oder auszuschalten.
- Ein eigenes **„Animationen"-Untermenü**, um einzelne Animationstypen umzuschalten:
  **App öffnen**, **App schließen / Rückkehr** und **Menüs & Einstellungsmenü**.
...
- **Ordner** mit einem **Bearbeiten-Modus** zum Neuanordnen der Apps per Drag & Drop.
- **Favoriten-Liste** direkt auf dem Home-Screen — optional mit oder ohne Labels.
- **Konfigurierbare Favoriten-Umrandung** — wählbarer Umriss (Keine, Schwarz, Weiß, Akzent, Dezent).
...
- **Konfigurierbare Gesten** über ein eigenes **„Gesten"-Untermenü**: Aktion frei
  zuweisbar für **Doppeltippen** (und für **Schütteln**).
- Verfügbare Aktionen: **App-Drawer**, **Suche**, **Bildschirm sperren**, **Benachrichtigungen**,
  **Taschenlampe**, **Kamera**, **Nicht stören**, **bestimmte App öffnen**, **Einstellungen**.
