 ...
 * - Die Entsperr-Sitzung merkt sich prozessweit, welche Pakete aktuell freigeschaltet
 *   sind, damit nicht bei jedem Fensterwechsel erneut abgefragt wird, solange die App
 *   im Vordergrund bleibt. Service und Sperr-Activity laufen im selben Prozess.
 */
object AppLockManager {
    ...
    // --- Entsperr-Sitzung (prozessweit, In-Memory) ---
