    ...
    reports {
        filters {
            excludes {
                ...
                classes("com.example.androidlauncher.ui.SizeConfigMenuKt\$*")
                // Utils.kt wurde in vier fokussierte Dateien zerlegt (reine UI-/System-Wrapper):
                classes("com.example.androidlauncher.ui.SwipeAndBounceKt")
                classes("com.example.androidlauncher.ui.SwipeAndBounceKt\$*")
                classes("com.example.androidlauncher.ui.SwipeToCloseState")
                classes("com.example.androidlauncher.ui.SearchFieldKt")
                classes("com.example.androidlauncher.ui.SearchFieldKt\$*")
                classes("com.example.androidlauncher.ui.AppIconViewKt")
                classes("com.example.androidlauncher.ui.AppIconViewKt\$*")
                classes("com.example.androidlauncher.ui.LaunchOverlaysKt")
                classes("com.example.androidlauncher.ui.LaunchOverlaysKt\$*")
                classes("com.example.androidlauncher.SystemIntegrationKt")
                classes("com.example.androidlauncher.SystemIntegrationKt\$*")
                ...
                classes("*Hilt_*")
                // Neuer Compose-UI-Code (Dynamic Island, Edge-Lighting, Onboarding,
                // bewegbare Startbildschirm-Objekte): nicht unit-testbar, analog zu den
                // UI-Dateien oben. Testbare Logik liegt in data.* bzw. IslandState.kt.
                classes("com.example.androidlauncher.ui.onboarding.*")
                classes("com.example.androidlauncher.ui.DynamicIslandKt")
                classes("com.example.androidlauncher.ui.DynamicIslandKt\$*")
                classes("com.example.androidlauncher.ui.IslandExpandedCardKt")
                classes("com.example.androidlauncher.ui.IslandExpandedCardKt\$*")
                classes("com.example.androidlauncher.ui.NiagaraAppDrawerKt")
                classes("com.example.androidlauncher.ui.NiagaraAppDrawerKt\$*")
                classes("com.example.androidlauncher.ui.HomeAppScrubberKt")
                classes("com.example.androidlauncher.ui.HomeAppScrubberKt\$*")
                classes("com.example.androidlauncher.ui.WallpaperCropScreenKt")
                classes("com.example.androidlauncher.ui.WallpaperCropScreenKt\$*")
                classes("com.example.androidlauncher.ui.UninstallAppsMenuKt")
                classes("com.example.androidlauncher.ui.UninstallAppsMenuKt\$*")
                classes("com.example.androidlauncher.ui.AnimationsConfigMenuKt")
                classes("com.example.androidlauncher.ui.AnimationsConfigMenuKt\$*")
                classes("com.example.androidlauncher.ui.EdgeLightingConfigMenuKt")
                classes("com.example.androidlauncher.ui.EdgeLightingConfigMenuKt\$*")
                classes("com.example.androidlauncher.ui.GesturesConfigMenuKt")
                classes("com.example.androidlauncher.ui.GesturesConfigMenuKt\$*")
                classes("com.example.androidlauncher.ui.AppLockScreenKt")
                classes("com.example.androidlauncher.ui.AppLockScreenKt\$*")
                classes("com.example.androidlauncher.ui.ColorWheelPickerKt")
                classes("com.example.androidlauncher.ui.ColorWheelPickerKt\$*")
                classes("com.example.androidlauncher.ui.WallpaperEyedropperKt")
                classes("com.example.androidlauncher.ui.WallpaperEyedropperKt\$*")
                classes("com.example.androidlauncher.ui.EdgeLightingKt")
                classes("com.example.androidlauncher.ui.EdgeLightingKt\$*")
                classes("com.example.androidlauncher.ui.HiddenAppsMenuKt")
                classes("com.example.androidlauncher.ui.HiddenAppsMenuKt\$*")
                classes("com.example.androidlauncher.ui.DesignStyleMenuKt")
                classes("com.example.androidlauncher.ui.DesignStyleMenuKt\$*")
                classes("com.example.androidlauncher.ui.PinPadKt")
                classes("com.example.androidlauncher.ui.PinPadKt\$*")
                classes("com.example.androidlauncher.ui.DrawerSearchBarKt")
                classes("com.example.androidlauncher.ui.DrawerSearchBarKt\$*")
                classes("com.example.androidlauncher.ui.AnimationUtilsKt")
                classes("com.example.androidlauncher.ui.AnimationUtilsKt\$*")
                classes("com.example.androidlauncher.ui.WallpaperBitmapKt")
                classes("com.example.androidlauncher.ui.WallpaperBitmapKt\$*")
            }
        }
